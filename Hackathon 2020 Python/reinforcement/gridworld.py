...
# Caedmon, Grisha, and Noah adapted this code for FRC use.
# Please leave all atribution info and add your own if you worked on and publicly published this code
...
class Grid:
    ...
    Useful numbers. 1. The size of half the field is 104472.5^2 in.  2. The field is 319 inches wide. and half of a field is 327.5 in.
    """
